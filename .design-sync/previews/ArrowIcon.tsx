// ArrowIcon — the submit/forward affordance (prompt-pill ask button).
import { ArrowIcon } from 'beacon-frontend'
...
export const Sizes = () => (<Tile><Chip><ArrowIcon size={30} /></Chip><Chip><ArrowIcon size={20} /></Chip></Tile>)
