// ResetIcon — re-arm / start-over control (results-phase Reset button).
import { ResetIcon } from 'beacon-frontend'
...
export const Sizes = () => (<Tile><Chip><ResetIcon size={30} /></Chip><Chip><ResetIcon size={20} /></Chip></Tile>)
