// LockIcon — restricted / access-gated state (amber by default).
import { LockIcon } from 'beacon-frontend'
...
export const Sizes = () => (<Tile><Chip><LockIcon size={30} /></Chip><Chip><LockIcon size={20} /></Chip></Tile>)
